...
<body>
  ...
  <nav>
      <form action="#" method="get" class="search">
          ...
          <a href="php/carrito.php"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-cart4" viewBox="0 0 16 16">
 ...
 <main>
  ...
  <table>
  <tr>
      <td> <a href="pastillas.html"><img <img id="Menu" src="img/pastillasLogo.jpeg"></a></td>
        <td> <a href="vitaminas.html"><img <img id="Menu" src="img/vitaminas.Logo.jpeg"></a></td>
           <td> <a href="inyecciones.html"><img <img id="Menu" src="img/inyeccionesLogo.jpeg"></a></td>
              <td> <a href="rostro.html"><img <img id="Menu" src="img/rostroLogo.jpeg"></a></td>
                 <td> <a href="gotas.html"><img <img id="Menu" src="img/gotasLogo.jpeg"></a></td>
                    <td> <a href="frascos.html"><img <img id="Menu" src="img/frascosLogo.jpeg"></a></td>
                        <td> <a href="objetos.html"><img <img id="Menu" src="img/objetosLogo.jpeg"></a></td>
   </td>
   </tr>
    </table>
    <br><br>
   <table>
   <tr>
     <td><img <img id="producto" src="img/principal1.png">
      <center>
      <p>Nombre: Polvos Nailen</p>
      <p>Precio: $10.300</p>
       <br>
       <a href="php/carrito.php" style="height: 50px; width: 50px;"><button style="background-color: #559EC4; color: black; height: 40px; width: 120px; border-radius: 15px; border: none;">Agregar al carrito</button></a>

       </td>
    <td><img <img id="producto" src="img/principal2.png">
      <center>
      <p>Nombre: Pestañina</p>
      <p>Precio: $20.000</p>
        <br>
       <a href="php/carrito.php" style="height: 50px; width: 50px;"><button style="background-color: #559EC4; color: black; height: 40px; width: 120px; border-radius: 15px; border: none;">Agregar al carrito</button></a>

    </td>
    <td><img <img id="producto" src="img/principal3.png">
      <center>
      <p>Nombre: Amoxaxilina</p>
      <p>Precio: $17.990</p>
        <br>
       <a href="php/carrito.php" style="height: 50px; width: 50px;"><button style="background-color: #559EC4; color: black; height: 40px; width: 120px; border-radius: 15px; border: none;">Agregar al carrito</button></a>
